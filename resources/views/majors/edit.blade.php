  ...
  <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8"> 
       ...
       <div> 
         ...
         <label for="code" 
           ...
           class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Kode</label> 

         <input type="text" id="code" name="code" value="AKL" 

           class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm value:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none"> 
       ...
       <div> 
         ...
         <input type="textarea" id="description" name="description" value="Program keahlian yang membekali murid dengan kompetensi pencatatan dan pelaporan keuangan." 
