     ...
     <form action="" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8"> 
       ...
       <div> 
         ...
         <select id="major" name="major" 
           ...
           <option placeholder="" selected>AKL</option> 

           <option placeholder="">TKJ</option> 

           <option placeholder="">BiD</option> 
       ...
       <div> 
         ...
         <input type="text" id="homeroom_class" name="homeroom_class" placeholder="Budi Santoso" 
